...
#%% ##--------- LOAD LIBRARIES ---------##
from riotwatcher import ValWatcher #'pip install riotwatcher' in Anaconda prompt
...
def setup_env():
    ...
    lol_watcher = ValWatcher(api_key) #Tell Riot Watcher to use LoL functions with the API key
    del(api_key)
    return lol_watcher
